...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
  <head>
    ...
    <![endif]-->
    <!--[if IE 8]>
     <link rel="stylesheet" type="text/css" href="<?php echo base_path() . drupal_get_path('theme', 'rmi'); ?>/css/ie8.css" media="screen" />
    <![endif]-->
  ...
  <body>
    <div id="header_wraps">
      ...
      if (arg(0) === 'user' && arg(1) === 'login') {
        // When User visits the login pages
        ?>
        <div id="body_bg">
          <div class="body-wrapper">
            <div class="wrapper">
              <?php
              if ($show_messages && $messages): print '<div>' . $messages . '</div>';
              endif;
              ?>
              <div class="logins">
                <?php print $content; ?>
        ...
        // When user user or the visitor is viewing other pages.
        ?>
        <div class="wrapper">
          <div class="wrap">
            <?php
            if ($show_messages && $messages): print '<div style="margin-bottom: 15px">' . $messages . '</div>';
            endif;
            ?>
            <div class="page_panel">
              <div class="page_panel_blue_belt"><div class="page_panel_header"><?php print $title; ?></div><div class="clear"></div></div>
