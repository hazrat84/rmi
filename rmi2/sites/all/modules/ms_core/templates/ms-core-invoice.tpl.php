...
<?php } ?>
  ...
  <body>
    <table width="95%" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#00aa66" style="font-family: verdana, arial, helvetica; font-size: small;">
      <tr>
        <td>
              ...
              <td>
                ...
                <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                  ...
                  <tr>
                    ...
                    <td width="98%">
                      <?php echo ms_core_get_gateway_name($order->gateway); ?>
                    </td>
                  </tr>
                    ...
                    <td colspan="2">
                      ...
                      <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                        <tr>
                          ...
                          <?php if (variable_get('ms_checkout_form_show_shipping_fields', FALSE)) { ?>
                          <td valign="top" width="50%">
                            <b><?php echo t('Shipping Address:'); ?></b><br />
                            <?php echo $order->shipping_address['first_name']; ?>
                            <?php echo $order->shipping_address['last_name']; ?> <br />
                    ...
                    <td colspan="2">
                      ...
                      <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                        <tr>
                          ...
                          <td width="98%">
                            <?php echo l($order->order_number, 'admin/moneyscripts/orders/view/'. $order->order_key); ?>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td width="98%">
                            <?php echo date('M d, Y', $order->created); ?>
                          </td>
                        </tr>
                  ...
                  <tr>
                    <td colspan="2">
                      <?php echo ms_core_get_order_payments_table($order); ?>
                    </td>
                  </tr>
